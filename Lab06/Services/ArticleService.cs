...
public class ArticleService : IArticleService
{
    ...
    {
        return await _unitOfWork.ArticleRepository.GetLatestAsync(count, cancellationToken);
    }

    public async Task<int> CountByCategoryAsync(int categoryId, CancellationToken cancellationToken = default)
    {
        return await _unitOfWork.ArticleRepository.CountByCategoryAsync(categoryId, cancellationToken);
    }
    ...
    {
        return await _unitOfWork.ArticleRepository.GetPagedByCategoryAsync(categoryId, page, pageSize, cancellationToken);
    }
}